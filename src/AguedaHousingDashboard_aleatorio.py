...
from Plots_AguedaHousingDashboard_Aleatorio import *
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            html.P(
                "Áreas: ocupação do solo", 
                className="text-center",
            ),
            html.Div(
                children = [init_areas(df, titulos_tabela_areas)],
                id ="tabela-areas-div",
                )
    ...
    dbc.Row([
        dbc.Col([
         ...
         dbc.Col([
            ...
            html.P(
                "Relação entre a área e a tipologia", 
                className="text-center",
                style={"font-size": "%spx" % (TITLE_FONT_SIZE), "font-family":"%s" % (TITLE_FONT_FAMILY), "color": "%s" %(TITLE_FONT_COLOR)}
            ),
            html.Div(
        ...
        dbc.Col([
            ...
            html.P(
                "Relação entre a altura e o número de pisos", 
                className="text-center",
                style={"font-size": "%spx" % (TITLE_FONT_SIZE), "font-family":"%s" % (TITLE_FONT_FAMILY), "color": "%s" %(TITLE_FONT_COLOR)}
            ),
            html.Div(
...
def update_data(clicked_data, n_clicks):
    ...
    return update_categoria_obra(freq, index_selecionado), \
        update_areas(df, titulos_tabela_areas, categoria_selecionada),\
